<html>
    ...
    <body class=" flex justify-center items-center p-4  bg-gray-100">
        ...
        <div class="max-w-sm  rounded-md overflow-hidden shadow-2xl bg-white">
            ...
            <span class="font-medium p-4 text-3xl text-white"> Login.</span>
            </div>
            <div class="flex justify-center pt-10 ">
                <form method="POST" action="/access" class="bg-white pt-10 flex flex-wrap justify-center space-y-3">
                {{ csrf_field() }}
                    <input type="text" 
                            name="email"
                             id="email"
            ...
            ex ea consequat? <a href="register" class="text-blue-800">register</a>
            </span>
